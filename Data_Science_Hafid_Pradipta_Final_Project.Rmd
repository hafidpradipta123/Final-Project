...
The dataset contains 228 variables. However, some of the variables are the extension of one information. For example, all variables started with WorkToolsFrequency refers to what kind of the work tools that the employee often used for their job.
